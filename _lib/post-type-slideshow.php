...
function slideshow_post_type() {
    ...
    $labels = array(
        ...
        'featured_image'        => __( 'Slideshow Image', 'text_domain' ),
        'set_featured_image'    => __( 'Set slideshow image', 'text_domain' ),
        'remove_featured_image' => __( 'Remove slideshow image', 'text_domain' ),
        'use_featured_image'    => __( 'Use as slideshow image', 'text_domain' ),
    ...
    $args = array(
        ...
        'description'           => __( 'Slideshow for home page', 'text_domain' ),
        'labels'                => $labels,
